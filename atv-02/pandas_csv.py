...
# diretamente de um arquivo do excel com a extensão csv e faça a impressão na tela informando:
#
...
def main():
    ...
    arquivo_dataframe = pandas.read_csv(nome_arquivo)
